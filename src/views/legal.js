  ...
  <section class="section section-flush">
    <div class="container container-narrow">
      <div class="prose">
        ...
        <p class="doc-note" data-reveal>Last updated: 2026-09-22 · Source: <a href="https://aisubscription.shop${esc(page.path)}" rel="noopener" target="_blank">aisubscription.shop${esc(page.path)}</a></p>
      </div>
    </div>
  </section>`;
}
...
export function notFoundPage() {
  ...
  <section class="page-hero not-found">
    <div class="container container-narrow">
      <p class="nf-code" data-reveal aria-hidden="true">404</p>
